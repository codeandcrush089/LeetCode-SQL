...
![Medium](https://img.shields.io/badge/Level-Medium-yellow?style=for-the-badge) [![Problem Link](https://img.shields.io/badge/LeetCode-Link-orange?style=for-the-badge&logo=leetcode)](https://leetcode.com/problems/analyze-subscription-conversion/description/)
...
* **`F` CTE**
  ...
  * Extracts each user’s **average free_trial duration**.

* **`P` CTE**

  * Extracts each user’s **average paid duration**.
