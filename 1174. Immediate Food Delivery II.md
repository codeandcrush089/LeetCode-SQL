...
![Medium](https://img.shields.io/badge/Level-Medium-yellow?style=for-the-badge) [![Problem Link](https://img.shields.io/badge/LeetCode-Link-orange?style=for-the-badge&logo=leetcode)](https://leetcode.com/problems/immediate-food-delivery-ii/description/)
...
* For each row:
  ...
  * Adds **1** if the **order date equals the preferred delivery date** → this is an **immediate first order**.
  * Adds **0** otherwise.
