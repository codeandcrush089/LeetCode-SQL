...
![Medium](https://img.shields.io/badge/Level-Medium-yellow?style=for-the-badge) [![Problem Link](https://img.shields.io/badge/LeetCode-Link-orange?style=for-the-badge&logo=leetcode)](https://leetcode.com/problems/capital-gainloss/description/)
...
Retrieves each distinct stock’s name.
...
* Uses **conditional aggregation**:
  ...
  * **Sell** → adds the price (profit)
  * **Buy** → subtracts the price (cost)
