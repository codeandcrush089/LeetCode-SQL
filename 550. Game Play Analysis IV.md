...
![Medium](https://img.shields.io/badge/Level-Medium-yellow?style=for-the-badge) [![Problem Link](https://img.shields.io/badge/LeetCode-Link-orange?style=for-the-badge&logo=leetcode)](https://leetcode.com/problems/game-play-analysis-iv/description/)
...
* Uses `MIN(event_date)` to get each player’s **first login date**.
...
* Numerator → number of players who logged in again the next day.
