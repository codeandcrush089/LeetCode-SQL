...
![Medium](https://img.shields.io/badge/Level-Medium-yellow?style=for-the-badge) [![Problem Link](https://img.shields.io/badge/LeetCode-Link-orange?style=for-the-badge&logo=leetcode)](https://leetcode.com/problems/product-price-at-a-given-date/description/)
...
* If a product has **no matching record in `t2`**, it still appears, but `t2.new_price` will be `NULL` → replaced by `10`.
