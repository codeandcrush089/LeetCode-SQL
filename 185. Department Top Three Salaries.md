...
![Hard](https://img.shields.io/badge/Level-Hard-red?style=for-the-badge) [![Problem Link](https://img.shields.io/badge/LeetCode-Link-orange?style=for-the-badge&logo=leetcode)](https://leetcode.com/problems/department-top-three-salaries/)
...
* Rank `1` → highest salary in the department
* Rank `2` → second highest **distinct** salary
* Rank `3` → third highest **distinct** salary
