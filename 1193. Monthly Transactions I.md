...
Counts the **total number of transactions** for each **month–country** combination.
...
Calculates the **total transaction amount** (approved + non-approved) for each **month–country** group.
