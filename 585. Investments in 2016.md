...
![Medium](https://img.shields.io/badge/Level-Medium-yellow?style=for-the-badge) [![Problem Link](https://img.shields.io/badge/LeetCode-Link-orange?style=for-the-badge&logo=leetcode)](https://leetcode.com/problems/investments-in-2016/)
...
### **2. Condition 1 – Non-unique `tiv_2015`**
...
* Ensures the policyholder’s `tiv_2015` is **not unique**.


### **3. Condition 2 – Unique location (`lat`, `lon`)**
...
* Ensures the policyholder’s location is **unique**.
